...
<head>
    ...
    <title>Application Profile - Lanka Epassport Service</title>
            ...
            <div class="col-lg-10">
                ...
                <div class="text-center mb-5">
                    <h1 class="display-5 fw-bold text-primary">
                        <i class="fas fa-id-card me-3"></i>Application Profile
                    </h1>
                    <p class="lead text-muted">View detailed information about your passport application</p>
                </div>
